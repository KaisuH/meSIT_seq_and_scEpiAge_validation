...
# Reading the data
electropherogram_data <- read.csv("path_to_your_electropherogram_file.csv")

# Melting the data for use with ggplot2
library(reshape2)
electropherogram_melted <- melt(electropherogram_data, id.vars = "SizeOrTimeColumn")

# Plotting the data
ggplot(data = electropherogram_melted, aes(x = SizeOrTimeColumn, y = value, color = variable)) +
  geom_line() +
  labs(x = "Size / Time Points", y = "Signal Intensity", title = "Electropherogram of Library Samples") +
  theme_minimal() +
